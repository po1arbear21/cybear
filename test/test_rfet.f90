...
contains
  ...
  subroutine solve_steady_state()
    ...
    do si = 1, size(sids)
      ...
      call ss%init_output([new_string("pot"), new_string("ndens"), new_string("pdens"),new_string("Ex"), new_string("Ey"), &
        & new_string("V_SG"), new_string("V_DG"), new_string("I_SRC"), new_string("I_DRN"), &
        & new_string("I_n_DRN"), new_string("I_p_DRN"),new_string("nimref"), new_string("pimref")], name%s // ".fbs")
